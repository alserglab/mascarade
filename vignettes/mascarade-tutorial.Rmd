...
```{r seuratdata-setup, message=FALSE, warning=FALSE}
if (!requireNamespace("SeuratData", quietly = TRUE)) {
  knitr::opts_chunk$set(eval = FALSE)
  message(
    "Package 'SeuratData' is not installed. ",
    "The code chunks in this vignette will not be evaluated.\n",
    "To run them, install it via:\n",
